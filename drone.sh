...
/bin/su - drone -c "/usr/bin/wget https://emmy8.casa.umass.edu/flynetDemo/listenToBasestation.tar; /bin/tar -xf listenToBasestation.tar"
/bin/su - drone -c "/usr/bin/wget https://emmy8.casa.umass.edu/flynetDemo/sendToBasestation.tar; /bin/tar -xf sendToBasestation.tar"
