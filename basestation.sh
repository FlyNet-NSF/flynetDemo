...
/bin/su - basestation -c "/usr/bin/wget https://emmy8.casa.umass.edu/flynetDemo/docker-compose.yml"
/bin/su - basestation -c "/usr/bin/wget https://emmy8.casa.umass.edu/flynetDemo/rabbitmq.tar; /bin/tar -xf rabbitmq.tar"
/bin/su - basestation -c "/usr/local/bin/docker-compose up -d"
/bin/su - basestation -c "/usr/bin/wget https://emmy8.casa.umass.edu/flynetDemo/listenToDrone.tar; /bin/tar -xf listenToDrone.tar"
